...
def load_tick_data(
    ...
    for vt_symbol in spread.legs.keys():
        ...
        bar_data: List[BarData] = database_manager.load_tick_data(
    ...
    for dt in bars.keys():
        ...
        for leg in spread.legs.values():
            ...
            if leg_bar:
                price_multiplier = spread.price_multipliers[leg.vt_symbol]
                spread_ask1 += price_multiplier * leg_bar.ask_price_1
                spread_bid1 += price_multiplier * leg_bar.bid_price_1
                spread_value += (spread_ask1 + spread_bid1) / 2
            else:
                spread_available = False
        ...
        if spread_available:
            ...
            spread_bar = TickData(
                ...
                exchange=exchange.LOCAL,
                datetime=dt,
                ask_price_1=spread_ask1,
                bid_price_1=spread_bid1,
                gateway_name="SPREAD",
            )
            spread_bar.value = spread_value
            spread_bars.append(spread_bar)
