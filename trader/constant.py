...
class OrderPriceType(Enum):
    """
    Reason why send this order
    """
    StopWinClose = 'StopWinClose'
    StopWinOpen = 'StopWinOpen'
    Hedging = 'Hedging'
    MarketMakingOpen = 'MarketMakingOpen'
    MarketMakingClose = 'MarketMakingClose'
    PassiveClose = 'PassiveClose'
